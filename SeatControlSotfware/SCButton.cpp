...
/************************************************************************************************************
函数名：RecMotorPosition(QVector<quint16> RecMotorPosition)
参数：QVector<quint16> RecMotorPosition  电机全开全收位置值
函数功能：读取参数界面最后的电机全收全开的位置值，方便进行全开全收往复测试
返回值：无
************************************************************************************************************/
